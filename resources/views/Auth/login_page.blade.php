...
<script>
	...
	<div class="btn pull-right">
				<a href="{{ Url('/admin/login') }}" class="btn btn-danger">Admin Panel</a>
			</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="booking-form">
						<form method="post" action="{{ Url('/user/login/process') }}">
								@csrf
							
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										<span class="form-label"><font color="">User Email</font></span>
                                       <input type="email" class="form-control" placeholder="Enter User Email" name="email" required>
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
                                    <span class="form-label">Password</font></span>
						...
						<br>
						<a href="{{ url('/user/forget-password') }}"><font color="">Forget Password ? </font></a>
