			...
			<div class="container">
				<div class="row">
					<div class="booking-form">
						<form method="post" action="{{ Url('admin/confirm-email') }}">
							
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
									@csrf
										<span class="form-label"><font color="">Email Verification Code</font></span>
                                       <input type="text" class="form-control" placeholder="Enter verfication code" name="code" required>
									</div>
								</div>
