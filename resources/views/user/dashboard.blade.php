...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="{{ Url('/user/dashboard/'.$row->id) }}">DashBoard</a></li>
      <li class=""><a href="{{ Url('purchase/history/'.$row->id) }}">Purchase History</a></li>
...
<a href="{{ Url('/user/dashboard/edit/'.$row->id) }}" class="btn btn-danger">Edit Info</a>
</div>
@if($row->photo)
...
@endif
<a href="{{ Url('/user/change/profile-picture/'.$row->id) }}" aria-label="Change Profile Picture">
...
<font color="red"><h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $row->name }}</h1></font>
