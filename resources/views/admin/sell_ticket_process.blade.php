...
@endphp
  ...
  <div class="container-fluid">
    ...
    <li><a href="{{ Url('/admin/home') }}">Home</a></li>
	  ...
	  <li class="active"><a href="{{ Url('/sell-ticket') }}">Sell Ticket</a></li>
...
<h3><font color="red"><b>Sell Ticket</b></font></h3>
</center>
<br>
<div class="frm">
    @foreach($train as $row)
  <form action="{{ Url('/sell-ticket/confirm/'.$row->id) }}" method="post">
    @csrf
    ...
    <br>
    <select name="destination_station" class="">
                                        <option value="{{ $row->destination_station }}"selected readonly>{{ $row->destination_station }}</option>
    ...
    <label for="lname">Destination Time</label>
    <br>
    <input type="time" id="lname" name="destination_time" placeholder="Enter Train Number.." value="{{ $row->destination_time }}" readonly required>

    <br>

    <label for="lname">Date</label>
    <br>
    <input type="date" id="lname" name="date" placeholder="Enter Train Number.." min="{{ $date }}" max="{{ $max }}" value="{{ $date }}"  required>
