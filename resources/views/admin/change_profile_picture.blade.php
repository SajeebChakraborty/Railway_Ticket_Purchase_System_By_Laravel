...
<br>
<form method="post" action="{{ Url('/admin/change/profile-picture/process/'.$admin_id) }}" enctype="multipart/form-data">
@csrf
<div class="container">
<div class="col-md-6">
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <span class="input-group-btn">
                ...
                <center>    Browse… <input type="file" id="imgInp" name="picture" required></center>
