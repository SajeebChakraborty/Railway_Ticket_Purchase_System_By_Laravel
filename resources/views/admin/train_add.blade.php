...
@endphp
  ...
  <div class="container-fluid">
    ...
    <li><a href="{{ Url('/admin/home') }}">Home</a></li>
      ...
      <li class="active"><a href="{{ Url('admin/train/add') }}">Add Train</a></li>
...
<h3><font color="red"><b>Add Train</b></font></h3>
</center>
<br>
<div class="frm">
  <form action="{{ Url('/admin/train/add/process') }}" method="post">
    @csrf
    ...
    <br>
    <input type="text" id="lname" name="train_name" placeholder="Enter Train Name.." required>
    <br>
    ...
    <br>
    <input type="time" id="lname" name="destination_time" placeholder="Enter Train Number.." required>
